...
public class CourseCollection implements Serializable {
	...
	/**
	 * description:
	 * boolean method to search for a courseSubject within a Course object 
	 * Precondition:
	 * method takes in an String value or courseSubject to search for
	 * Postcondition:
	 * after execution the method returns a true or false value depending on if the courseSubject was found
	 * Throws:
	 */
